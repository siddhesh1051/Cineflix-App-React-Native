                        ...
                        <View className="flex-col justify-center items-center ">
                            ...
                            <View className="flex-row justify-center items-center ">
                                ...
                                <TouchableOpacity
                                    ...
                                    className="rounded-xl px-3 py-2 my-2  mx-2 bg-neutral-500">
                                    <Text className="text-white font-semibold text-lg">My Favorites</Text>
                                </TouchableOpacity>
                                <TouchableOpacity
                                    onPress={() => navigation.navigate('WatchLater')}
                                    className="rounded-xl px-3 py-2 my-2  mx-2 bg-neutral-500">
                                    <Text className="text-white font-semibold text-lg">Watch Later</Text>
                                </TouchableOpacity>
                            </View>
                            <Image
